...
def get_access_token():
    ...
    if not REFRESH_TOKEN:
        logging.error("Refresh token is not set. Please check the ZOHO_REFRESH_TOKEN environment variable.")
        return None
    ...
    try:
        ...
        logging.info(f"Access token retrieved successfully. Expires in {expires_in} seconds.")
        return access_token
